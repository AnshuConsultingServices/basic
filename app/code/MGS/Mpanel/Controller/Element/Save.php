			...
			switch ($data['type']) {
				...
				case "owl_banner":
					...
					if(isset($data['setting']['images']) && (count($data['setting']['images'])>0)){
						$dataInit = ['fullscreen', 'autoplay', 'stop_auto', 'navigation', 'pagination', 'loop', 'parallax', 'fullscreen'];
						...
						$images = implode(',',$data['setting']['images']);
						$link = implode(',',$data['setting']['links']);
						
						$content = '{{block class="MGS\Mpanel\Block\Widget\OwlCarousel" images="'.$images.'" links="'.$link.'" fullscreen="'.$data['setting']['fullscreen'].'" autoplay="'.$data['setting']['autoplay'].'" stop_auto="'.$data['setting']['stop_auto'].'" navigation="'.$data['setting']['navigation'].'" offset="'.$data['setting']['offset'].'" parallax="'.$data['setting']['parallax'].'" fullheight="'.$data['setting']['fullheight'].'" pagination="'.$data['setting']['pagination'].'" loop="'.$data['setting']['loop'].'" speed="'.$speed.'" effect="'.$data['setting']['effect'].'" template="widget/owl_slider.phtml"}}';
				...
				/* Instagram Block */
				case "instagram":
					$dataInit = ['link', 'like', 'use_slider', 'autoplay', 'stop_auto', 'navigation', 'pagination', 'comment', 'padding'];
					$data = $this->reInitData($data, $dataInit);
					$content = '{{block class="MGS\Social\Block\Panel\Widget" mgs_panel_title="'.$this->encodeHtml($data['setting']['title']).'" mgs_panel_note="'.$this->encodeHtml($data['setting']['additional_content']).'" limit="'.$data['setting']['limit'].'" resolution="'.$data['setting']['resolution'].'" link="'.$data['setting']['link'].'" perrow="'.$data['setting']['perrow'].'" use_slider="'.$data['setting']['use_slider'].'" padding="'.$data['setting']['padding'].'" like="'.$data['setting']['like'].'" comment="'.$data['setting']['comment'].'"';
