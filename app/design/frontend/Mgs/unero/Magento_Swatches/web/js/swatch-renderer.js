        ...
        updateBaseImage: function (images, context, isProductViewExist) {
            ...
            if (isProductViewExist) {
                ...
                if(imagesToUpdate.length > 1){
                    img_change = img_change + '<div class="vertical-thumbnail">';
                    img_change = img_change + '<div class="parent__gallery-thumbnail"><div class="product-gallery-carousel gallery-thumbnail slick-thumbnail">';
                        $.each(imagesToUpdate, function(index) {
                            if(imagesToUpdate[index]['isMain']){
                                img_change = img_change + '<div class="item"><div class="image-item base-image active" data-owlmove="'+index+'"><img class="img-responsive" src="'+imagesToUpdate[index]['full']+'" alt=""/></div></div>';
                            }else{
                                img_change = img_change + '<div class="item"><div class="image-item" data-owlmove="'+index+'"><img class="img-responsive" src="'+imagesToUpdate[index]['full']+'" alt=""/></div></div>';
                            }
                        });
                    img_change = img_change + '</div></div>';
                    
                    img_change = img_change + '<div class="product-main-media-product"><div class="product-image-base"><div class="product-gallery-base-carousel owl-carousel">';
                        $.each(imagesToUpdate, function(index) {
                            img_change = img_change + '<div class="item"><a href="'+imagesToUpdate[index]['full']+'"><img class="img-responsive" src="'+imagesToUpdate[index]['full']+'" alt=""/></a></div>';
                        });
                    img_change = img_change + '</div></div></div></div>';
                }else {
                    img_change = img_change + '<div class="placeholder-images"><img class="img-responsive" src="'+imagesToUpdate[0]['full']+'" alt=""/></div>';
                }
                img_change = img_change + '<div class="vertical-thumbnail">';
